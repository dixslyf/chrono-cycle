...
export type DbEventDependencyInsert = z.input<
    typeof eventDependencyInsertSchema
>;
export type DbEventDependencyUpdate = z.input<
    typeof eventDependencyUpdateSchema
>;
