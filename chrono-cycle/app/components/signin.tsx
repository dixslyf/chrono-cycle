...
const SigninForm = () =>  {
    ...
    return (
        <div className="w-full h-full border border-purple-700 flex flex-col gap-10">
            {/* header */}
            <h1 className="text-[#5e5034] font-bold text-3xl p-5">Sign In</h1>       
            <form action="" className="flex flex-col items-center gap-10">
    
                {/* username input */}
                <div className="flex flex-col w-3/4 gap-2">
                    <label htmlFor="uname" className="text-[#0a0906]">
                ...
                {/* button */}
                <button className="w-3/4 p-1 rounded-xl bg-[#a9927d] hover:bg-[#a08368] transition duration-300 text-[#f2f4f3]">
                    Sign In
                </button>
