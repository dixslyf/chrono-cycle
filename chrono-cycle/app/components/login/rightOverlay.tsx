...
const RightOverlay: React.FC<RightOverlayProps> = ({ isSignUpActive: isSignUpActive, setSignUpActive: setSignUpActive}) => {
    return (
        <div className="flex flex-col h-full items-center justify-center gap-20">
            ...
            <div className="w-full flex flex-col items-center gap-3">
                <h3 className="text-lg text-gray-200">Don&apos;t have an account?</h3>
