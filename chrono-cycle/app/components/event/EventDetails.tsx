...
import { Event, Reminder, Tag } from "@/server/common/data";
import { Stack, Text, Paper, Group, Badge, Checkbox, Divider, Box } from "@mantine/core";
...
function DisplayEventDetails({ event }: DisplayEventDetailsProps) {
  ...
  return (
    <Paper p="md" radius="md" withBorder>
      ...
      <Stack gap="md">
        ...
        <Group justify="apart">
          <Stack gap="xs" style={{ flex: 1 }}>
            ...
            <Text>{event.eventType === 'task' ? 'Task' : 'Activity'}</Text>
          </Stack>
      ...
      {/* Reminders Section */}
      <Stack gap="md">
        <Text fw={700} size="lg">Reminders</Text>
        ...
        {event.reminders.length > 0 ? (
          ...
          <Text c="dimmed" style={{ fontStyle: 'italic' }}>No reminders set</Text>
        )}
      </Stack>
      ...
      <Stack gap="md">
        <Text fw={700} size="lg">Miscellaneous</Text>
        ...
        <Stack gap="xs">
          ...
          {event.tags.length > 0 ? (
            ...
            <Text c="dimmed" style={{ fontStyle: 'italic' }}>No tags assigned</Text>
          )}
        </Stack>
          ...
          <Stack gap="xs">
            ...
            <Badge 
              color={
                ...
                event.status === 'not started' ? 'yellow' : 'gray'
              }
            >
